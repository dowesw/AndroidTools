...
public class PrinterCommands {
    ...
    public static final byte[][] TEXT_ALIGN = new byte[][]{TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, TEXT_ALIGN_RIGHT};
    ...
    public static final byte[][] TEXT_WEIGHT = new byte[][]{TEXT_WEIGHT_NORMAL, TEXT_WEIGHT_BOLD};
    ...
    public static final byte[][] TEXT_SIZE = new byte[][]{TEXT_SIZE_NORMAL, TEXT_SIZE_MEDIUM, TEXT_SIZE_BIG, TEXT_SIZE_DOUBLE_HEIGHT, TEXT_SIZE_DOUBLE_WIDTH};
